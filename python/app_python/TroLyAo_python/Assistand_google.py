...
def speak(text):
    ...
    os.remove("D:\TroLyAo_python\lehonganh.mp3")
    time.sleep(1)
    tts.save("D:\TroLyAo_python\lehonganh.mp3")
    time.sleep(1)
    playsound.playsound("D:\TroLyAo_python\lehonganh.mp3", True)
...
def get_audio():
    ...
    with sr.Microphone() as source:
        ...
        audio = assistant_ear.listen(source, phrase_time_limit=5)
        try:
...
def send_email(text):
    ...
    if 'tôi' in recipient:
        ...
        mail.ehlo()
        mail.starttls()
        mail.login('lea81807@gmail.com', 'hqenlurtqbhpedka')
        mail.sendmail('leanh17101601@gmail.com',
                      'lephuong171016@gmail.com', content.encode('utf-8'))
        mail.close()
